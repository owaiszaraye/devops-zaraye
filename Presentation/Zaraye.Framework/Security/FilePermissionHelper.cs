...
using Zaraye.Services.Plugins;

namespace Zaraye.Framework.Security
{
    /// <summary>
    ...
    public static class FilePermissionHelper
    {
        ...
        [SupportedOSPlatform("windows")]
        private static bool CheckPermissionsInWindows(IZarayeFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
        {
        ...
        /// <param name="checkDelete">Check delete</param>
        /// <returns>Result</returns>
        public static bool CheckPermissions(this IZarayeFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
        {
        ...
        /// </summary>
        /// <returns>Result</returns>
        public static IEnumerable<string> GetDirectoriesWrite(this IZarayeFileProvider fileProvider)
        {
        ...
        /// </summary>
        /// <returns>Result</returns>
        public static IEnumerable<string> GetFilesWrite(this IZarayeFileProvider fileProvider)
        {
