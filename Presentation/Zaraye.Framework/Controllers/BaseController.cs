...
using Zaraye.Framework.Mvc.Filters;
//using Zaraye.Framework.UI;

namespace Zaraye.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract partial class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedCardName(string cardName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedCardName" method of \Zaraye.Framework\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \Zaraye.Framework\Extensions\HtmlExtensions.cs
