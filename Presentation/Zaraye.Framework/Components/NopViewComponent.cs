...
using Zaraye.Framework.Events;
using Zaraye.Framework.Models;

namespace Zaraye.Framework.Components
{
    /// <summary>
    ...
    public abstract partial class NopViewComponent : ViewComponent
    {
        private void PublishModelPrepared<TModel>(TModel model)
        {
            ...
            //as we do in the /Zaraye.Framework/Mvc/Filters/PublishModelEventsAttribute.cs for controllers
