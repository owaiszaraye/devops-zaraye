...
namespace Zaraye.Infrastructure
{
    ...
    public partial class RouteProvider : BaseRouteProvider, IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            //order-placed
            endpointRouteBuilder.MapControllerRoute(name: "OrderPlaced",
                pattern: $"{lang}/order-placed/{{buyerrequestid:min(0)}}",
                defaults: new { controller = "Common", action = "OrderPlaced" });
            ...
            //solutions
            endpointRouteBuilder.MapControllerRoute(name: "Solutions",
                pattern: $"{lang}/solutions",
                defaults: new { controller = "Common", action = "Solutions" });

            //careers
            endpointRouteBuilder.MapControllerRoute(name: "TraineeshipProgram",
                pattern: $"{lang}/traineeship-program",
                defaults: new { controller = "Common", action = "TraineeshipProgram" });

            //careers
            endpointRouteBuilder.MapControllerRoute(name: "Career",
                pattern: $"{lang}/careers",
                defaults: new { controller = "Common", action = "Career" });

            //GetaQuote route
            endpointRouteBuilder.MapControllerRoute(name: "GetaConstructionQuote",
                pattern: $"{lang}/get-a-construction-quote",
                defaults: new { controller = "Common", action = "GetaConstructionQuote" });

            endpointRouteBuilder.MapControllerRoute(name: "GetaTextileQuote",
                pattern: $"{lang}/get-a-textile-quote",
                defaults: new { controller = "Common", action = "GetaTextileQuote" });

            endpointRouteBuilder.MapControllerRoute(name: "GetaPolymerQuote",
                pattern: $"{lang}/get-a-polymer-quote",
                defaults: new { controller = "Common", action = "GetaPolymerQuote" });

            endpointRouteBuilder.MapControllerRoute(name: "GetaQuote",
                pattern: $"{lang}/zaraye-get-a-quote",
                defaults: new { controller = "Common", action = "GetaQuote" });

            endpointRouteBuilder.MapControllerRoute(name: "GetaFinishedGoodsQuote",
                pattern: $"{lang}/get-a-finished-goods-quote",
                defaults: new { controller = "Common", action = "GetaFinishedGoodsQuote" });
            ...
            endpointRouteBuilder.MapControllerRoute(name: "GetContractGuid",
              pattern: $"download/get-contract/{{guid:guid}}",
              defaults: new { controller = "Download", action = "GetContractGuid" });
            ...
            //brands
            endpointRouteBuilder.MapControllerRoute(name: "BrandsAll",
                pattern: $"{lang}/brand/all",
                defaults: new { controller = "Catalog", action = "BrandsAll" });
            ...
            //SolutionsIndustry
            endpointRouteBuilder.MapControllerRoute(name: "SolutionsIndustry",
                pattern: $"{lang}/Solutions-By-Industry",
                defaults: new { controller = "Common", action = "SolutionsIndustry" });

            //SolutionsDepartment
            endpointRouteBuilder.MapControllerRoute(name: "SolutionsDepartment",
                pattern: $"{lang}/Solutions-By-Department",
                defaults: new { controller = "Common", action = "SolutionsDepartment" });

            //Pricing
            endpointRouteBuilder.MapControllerRoute(name: "Pricing",
                pattern: $"{lang}/Pricing",
                defaults: new { controller = "Common", action = "Pricing" });

            //AboutUs
            endpointRouteBuilder.MapControllerRoute(name: "AboutUs",
                pattern: $"{lang}/AboutUs",
                defaults: new { controller = "Common", action = "AboutUs" });

            //Careers
            endpointRouteBuilder.MapControllerRoute(name: "Careers",
                pattern: $"{lang}/Careers",
