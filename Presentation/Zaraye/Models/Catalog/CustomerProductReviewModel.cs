...
using Zaraye.Models.Common;

namespace Zaraye.Models.Catalog
{
    public partial record CustomerProductReviewModel : BaseZarayeModel
    {
    ...
    public partial record CustomerProductReviewsModel : BaseZarayeModel
    {
