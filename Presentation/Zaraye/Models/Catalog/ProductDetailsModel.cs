...
using Zaraye.Models.ShoppingCart;

namespace Zaraye.Models.Catalog
{
    public partial record ProductDetailsModel : BaseZarayeEntityModel
    {
        ...
        public partial record ProductBreadcrumbModel : BaseZarayeModel
        {
        ...
        public partial record AddToCartModel : BaseZarayeModel
        {
        ...
        public partial record ProductPriceModel : BaseZarayeModel
        {
            /// <summary>
        ...
        public partial record TierPriceModel : BaseZarayeModel
        {
            public string Price { get; set; }
            public decimal PriceValue { get; set; }
