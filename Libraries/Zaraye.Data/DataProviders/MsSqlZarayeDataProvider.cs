...
namespace Zaraye.Data.DataProviders
{
    ...
    /// </summary>
    public partial class MsSqlZarayeDataProvider : BaseDataProvider, IZarayeDataProvider
    {
        #region Utils
        ...
        public virtual string BuildConnectionString(IZarayeConnectionStringInfo zarayeConnectionString)
        {
            ...
            {
                DataSource = zarayeConnectionString.ServerName,
                InitialCatalog = zarayeConnectionString.DatabaseName,
                PersistSecurityInfo = false,
                IntegratedSecurity = zarayeConnectionString.IntegratedSecurity,
                TrustServerCertificate = true
            };

            if (!zarayeConnectionString.IntegratedSecurity)
            {
                builder.UserID = zarayeConnectionString.Username;
                builder.Password = zarayeConnectionString.Password;
            }
