...
{
    public partial class MySqlZarayeDataProvider : BaseDataProvider, IZarayeDataProvider
    {
        #region Fields
        ...
        public virtual string BuildConnectionString(IZarayeConnectionStringInfo zarayeConnectionString)
        {
            ...
            {
                Server = zarayeConnectionString.ServerName,
                ...
                UserID = zarayeConnectionString.Username,
