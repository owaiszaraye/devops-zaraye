...
namespace Zaraye.Data.Migrations
{
    ...
    /// </summary>
    public class ZarayeConventionSet : IConventionSet
    {
        #region Ctor

        public ZarayeConventionSet(IZarayeDataProvider dataProvider)
        {
