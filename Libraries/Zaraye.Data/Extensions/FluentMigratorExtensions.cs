...
using Zaraye.Data.Mapping.Builders;

namespace Zaraye.Data.Extensions
{
    /// <summary>
    ...
    public static class FluentMigratorExtensions
    {
        ...
        private static Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>> TypeMapping { get; } = new Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>>
        {
            ...
            [typeof(DateTime)] = c => c.AsZarayeDateTime2(),
        ...
        /// </summary>
        public static ICreateTableColumnOptionOrWithColumnSyntax AsZarayeDateTime2(this ICreateTableColumnAsTypeSyntax syntax)
        {
