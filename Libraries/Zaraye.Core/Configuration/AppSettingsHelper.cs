...
namespace Zaraye.Core.Configuration
{
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, IZarayeFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(ZarayeConfigurationDefaults.AppSettingsFilePath);
