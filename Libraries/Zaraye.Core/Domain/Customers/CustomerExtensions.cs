...
namespace Zaraye.Core.Domain.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(ZarayeCustomerDefaults.SearchEngineCustomerName, StringComparison.InvariantCultureIgnoreCase);
        ...
        public static bool IsBackgroundTaskAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(ZarayeCustomerDefaults.BackgroundTaskCustomerName, StringComparison.InvariantCultureIgnoreCase);
