...
namespace Zaraye.Core.Domain.Customers
{
    ...
    public partial class CustomerSettings : ISettings
    {
        ...
        public int TranspoterZaraye { get; set; }

        public int ThirdPartyCustomer { get; set; }

        public int LocalTransporterId { get; set; }
        ...
        public int DummySupplierId { get; set; }
        public int DummyBuyerId { get; set; }
        public int DummyBookerId { get; set; }
        public int DummyIndustryId { get; set; }
        public int DummyCategoryId { get; set; }
        public int DummyProductId { get; set; }
        public int DummyBrandId { get; set; }
