namespace Zaraye.Core.Domain.Customers
{
    ...
    /// </summary>
    public static partial class ZarayeCustomerDefaults
    {
        ...
        public static string BuyerRoleName => "Buyer";

        public static string SupplierRoleName => "Supplier";

        public static string BookerRoleName => "Booker";

        public static string BrokerRoleName => "Broker";

        public static string TransporterRoleName => "Transporter";

        public static string SupportAgentRoleName => "SupportAgent";

        public static string BusinessHeadRoleName => "BusinessHead";

        public static string FinanceRoleName => "Finance";

        public static string DemandRoleName => "Demand";

        public static string SupplyRoleName => "Supply";
        public static string GroundOperationsRoleName => "GroundOperations";
        public static string OrderBookerDemandRoleName => "OrderBookerDemand";
        public static string DemandAssociateRoleName => "DemandAssociate";
        public static string OPerationAssociateRoleName => "OPerationAssociate";
        public static string OPerationLeadRoleName => "OPerationLead";
        public static string BusinessLeadRoleName => "BusinessLead";
        public static string ControlTowerRoleName => "ControlTower";
        public static string SupplyAssociateRoleName => "SupplyAssociate";

        public static string OperationsRoleName => "Operations";

        public static string FinanceHeadRoleName => "FinanceHead";

        public static string OpsHeadRoleName => "OpsHead";

        public static string LiveOpsRoleName => "LiveOps";
        ...
        public static string ThirdPartyLedgerCustomerName => "ThirdPartyLedger";
        ...
        /// <summary>
        /// Gets a name of generic attribute to store the value of 'AreaId'
        /// </summary>
        public static string AreaIdAttribute => "AreaId";
        ...
        public static string SupplierIndustryIdAttribute => "SupplierCategoryId";

        //public static string OrderCommissionRateAttribute => "OrderCommissionRate";
        //public static string OrderDiscountRateAttribute => "OrderDiscountRate";

        //public static string OrderGrossRateCommissionAttribute => "OrderGrossRateCommission";
        //public static string OrderGrossRateCommissionTypeAttribute => "OrderGrossRateCommissionType";

        //public static string OrderNetRateGstAttribute => "OrderNetRateGst";
        //public static string OrderWhtRateAttribute => "OrderWhtRate";
        //public static string OrderTaxRateAttribute => "OrderTaxRate";
        //public static string OrderDeliveryCostAttribute => "OrderDeliveryCost";

        public static string TransporterTypeAttribute => "TransporterType";
        public static string BookerTypeAttribute => "BookerType";
        public static string CnicAttribute => "Cnic";
        public static string GstAttribute => "Gst";


        //Custom attributes for Hassan Excel Sheet
        public static string BuyerIndustryAttribute => "BuyerIndustry";
        public static string BuyerTypeIdAttribute => "BuyerTypeId";
        public static string SupplierTypeIdAttribute => "SupplierTypeId";

        public static string POCNameAttribute => "POCName";
        public static string AccountDeActivateCommentAttribute => "AccountDeActivateComment";
        //Close

        public static string RegisteredBookerCurrentLocationAttribute => "RegisteredBookerCurrentLocation";
        public static string RegisteredBookerCurrentLocationAddressAttribute => "RegisteredBookerCurrentLocationAddress";

        public static string RegisteredPinLocationAttribute => "RegisteredPinLocation";
        public static string RegisteredPinLocationAddressAttribute => "RegisteredPinLocationAddress";
        public static string AppDownloadPopup => "AppDownloadPopup";

        //otp
        public static string CustomerPhoneNumberOtp => "CustomerPhoneNumberOtp";
        public static string BuyerOtpVerification => "BuyerOtpVerification";
