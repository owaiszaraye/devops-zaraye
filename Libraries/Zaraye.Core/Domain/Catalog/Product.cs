...
namespace Zaraye.Core.Domain.Catalog
{
    ...
    /// </summary>
    public partial class Product : BaseEntity,StoreEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountProductMapping>, ISoftDeletedEntity, DefaultColumns, IActiveActivityLogEntity
    {
        /// <summary>
        ...
        public bool BestSellingProduct { get; set; }
        /// <summary>
