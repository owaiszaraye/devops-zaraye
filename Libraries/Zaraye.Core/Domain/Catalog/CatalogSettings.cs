...
namespace Zaraye.Core.Domain.Catalog
{
    ...
    public partial class CatalogSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to show bestsuppliers on home page
        /// </summary>
        public bool ShowBestsuppliersOnHomepage { get; set; }

        /// <summary>
        /// Gets or sets a number of bestsuppliers on home page
        /// </summary>
        public int NumberOfBestsuppliersOnHomepage { get; set; }
        ...
        public int DecimalsSettings { get; set; }
    }
}