...
namespace Zaraye.Core.Domain.Orders
{
    ...
    public partial class OrderSettings : ISettings
    {
        ...
        public string CustomSaleOrderNumberMask { get; set; }
        public string CustomReturnSaleOrderNumberMask { get; set; }

        public string CustomPurchaseOrderNumberMask { get; set; }
        public string CustomReturnPurchaseOrderNumberMask { get; set; }
        ...
        public string CustomRequestNumberMask { get; set; }
        public string CustomPurchaseRequestNumberMask { get; set; }
        public string CustomRfqNumberMask { get; set; }
        public string CustomQuotationNumberMask { get; set; }
        public string CustomPaymentNumberMask { get; set; }
        public string CustomPOShipmentNumberMask { get; set; }
        public string CustomSOShipmentNumberMask { get; set; }
        public string ConsumerAppServerKey { get; set; }
        public string TijaraAppServerKey { get; set; }
    }
}