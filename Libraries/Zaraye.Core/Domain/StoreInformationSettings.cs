...
namespace Zaraye.Core.Domain
{
    ...
    public partial class StoreInformationSettings : ISettings
    {
        ...
        /// Please find more info at https://www.zaraye.co/nopcommerce-copyright-removal-key
        /// </summary>
        public bool HidePoweredByZarayeCommerce { get; set; }
