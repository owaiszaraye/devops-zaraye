...
using Zaraye.Core.Infrastructure.Mapper;

namespace Zaraye.Core.Infrastructure
{
    /// <summary>
    /// Represents Nop engine
    /// </summary>
    public partial class ZarayeEngine : IEngine
    {
        #region Utilities
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var typeFinder = Singleton<ITypeFinder>.Instance;
            var startupConfigurations = typeFinder.FindClassesOfType<IZarayeStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IZarayeStartup)Activator.CreateInstance(startup))
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new ZarayeException("Unknown dependency");
                        return service;
                    });
            ...
            throw new ZarayeException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
