...
namespace Zaraye.Services.Configuration
{
    ...
    public partial interface ISettingService
    {
        ...
        Task DeleteShipmentReturnReasonAsync(ShipmentReturnReason returnRequestReason);

        Task<ShipmentReturnReason> GetShipmentReturnReasonByIdAsync(int returnRequestReasonId);

        Task InsertShipmentReturnReasonAsync(ShipmentReturnReason returnRequestReason);

        Task UpdateShipmentReturnReasonAsync(ShipmentReturnReason returnRequestReason);
        ...
        Task<IPagedList<ReturnRequestReason>> GetAllReturnRequestReasonAsync(int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false);
