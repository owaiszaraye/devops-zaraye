...
namespace Zaraye.Services.Caching
{
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(ZarayeEntityCacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(ZarayeEntityCacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(ZarayeEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
