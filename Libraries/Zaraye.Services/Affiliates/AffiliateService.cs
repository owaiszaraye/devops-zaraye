...
namespace Zaraye.Services.Affiliates
{
    /// <summary>
    /// Affiliate service
    /// </summary>
    public partial class AffiliateService : IAffiliateService
    {
        ...
        public virtual Task<string> GenerateUrlAsync(Affiliate affiliate)
        {
            ...
            var url = !string.IsNullOrEmpty(affiliate.FriendlyUrlName) ?
                //use friendly URL
                _webHelper.ModifyQueryString(storeUrl, ZarayeAffiliateDefaults.AffiliateQueryParameter, affiliate.FriendlyUrlName) :
                //use ID
                _webHelper.ModifyQueryString(storeUrl, ZarayeAffiliateDefaults.AffiliateIdQueryParameter, affiliate.Id.ToString());
        ...
        public virtual async Task<string> ValidateFriendlyUrlNameAsync(Affiliate affiliate, string friendlyUrlName)
        {
            ...
            friendlyUrlName = CommonHelper.EnsureMaximumLength(friendlyUrlName, ZarayeAffiliateDefaults.FriendlyUrlNameLength);
