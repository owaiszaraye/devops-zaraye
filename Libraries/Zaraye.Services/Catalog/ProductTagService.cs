...
namespace Zaraye.Services.Catalog
{
    ...
    public partial class ProductTagService : IProductTagService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.ProductTagsByProductCacheKey, productId);
        ...
        public virtual async Task<Dictionary<int, int>> GetProductCountAsync(int storeId, bool showHidden = false)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.ProductTagCountCacheKey, storeId, customerRoleIds, showHidden);
        ...
        public virtual async Task UpdateProductTagsAsync(Product product, string[] productTags)
        {
            ...
            //cache
            await _staticCacheManager.RemoveByPrefixAsync(ZarayeEntityCacheDefaults<ProductTag>.Prefix);
        }
