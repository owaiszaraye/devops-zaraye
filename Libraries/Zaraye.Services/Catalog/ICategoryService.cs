...
namespace Zaraye.Services.Catalog
{
    ...
    public partial interface ICategoryService
    {
        ...
        /// The task result contains the categories
        /// </returns>
        Task<IPagedList<Category>> GetAllCategoriesAsync(string categoryName, int storeId = 0, int industryId = 0,
        ...
        Task<IList<Category>> GetAllCategoriesByIndustryIdAsync(int industryId, bool? isAppPublished = null);
        /// <summary>
        ...
        Task<IPagedList<Category>> GetCategoriesByIndustryIdsAsync(
          int pageIndex = 0,
        ...
        /// </returns>
        Task<IList<ProductCategory>> GetProductCategoriesByProductIdAsync(int productId, bool showHidden = false, bool? isAppPublished = null);
        ...
        Task<IList<Category>> GetAllCategoriesDisplayedOnHomepageByIndustryIdAsync(int ParentCategoryId);

        Task<IList<Category>> SearchCategoriesAsync(string keywords, bool searchCategoryTags = false, bool showHidden = false, bool? overridePublished = null);
    }
}