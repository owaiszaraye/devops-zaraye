...
namespace Zaraye.Services.Catalog
{
    ...
    public partial class SpecificationAttributeService : ISpecificationAttributeService
    {
        ...
        public virtual async Task<IList<SpecificationAttributeGroup>> GetProductSpecificationAttributeGroupsAsync(int productId)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.SpecificationAttributeGroupByProductCacheKey, productId);
        ...
        public virtual async Task<IList<SpecificationAttribute>> GetSpecificationAttributesWithOptionsAsync()
        {
            ...
            return await _staticCacheManager.GetAsync(_staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.SpecificationAttributesWithOptionsCacheKey), async () => await query.ToListAsync());
        }
        ...
        public virtual async Task<IList<SpecificationAttributeOption>> GetSpecificationAttributeOptionsBySpecificationAttributeAsync(int specificationAttributeId)
        {
            ...
            var specificationAttributeOptions = await _staticCacheManager.GetAsync(_staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.SpecificationAttributeOptionsCacheKey, specificationAttributeId), async () => await query.ToListAsync());
        ...
        public virtual async Task<IList<SpecificationAttributeOption>> GetFiltrableSpecificationAttributeOptionsByCategoryIdAsync(int categoryId)
        {
            ...
            var result = 
                ...
                //see also https://github.com/Zaraye-Co/issues/5425
                select new { sa, sao };

            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(
                ZarayeCatalogDefaults.SpecificationAttributeOptionsByCategoryCacheKey, categoryId.ToString());
        ...
        public virtual async Task<IList<SpecificationAttributeOption>> GetFiltrableSpecificationAttributeOptionsByManufacturerIdAsync(int manufacturerId)
        {
            ...
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(
                ZarayeCatalogDefaults.SpecificationAttributeOptionsByManufacturerCacheKey, manufacturerId.ToString());
            ...
            int specificationAttributeOptionId = 0, bool? allowFiltering = null, bool? showOnProductPage = null, int? specificationAttributeGroupId = 0)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.ProductSpecificationAttributeByProductCacheKey,
