...
namespace Zaraye.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
        ...
        private readonly IRepository<ManufacturerManufacturerTagMapping> _manufacturerTagMappingRepository;
        ...
        public ManufacturerService(CatalogSettings catalogSettings,
            ...
            IRepository<ManufacturerManufacturerTagMapping> manufacturerTagMappingRepository,
            ...
            )
        {
            ...
            _manufacturerTagMappingRepository = manufacturerTagMappingRepository;
        ...
        public virtual async Task<IPagedList<Manufacturer>> GetAllManufacturersAsync(string manufacturerName = "",
              ...
              bool? overridePublished = null, bool? visibleContentPublishedOnly = null)
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.ManufacturerTagsByManufacturerCacheKey);

            var manufactures = await _staticCacheManager.GetAsync(key, async () =>
            {
                return await _manufacturerRepository.GetAllPagedAsync(async query =>
                {
                    ...
                    if (visibleContentPublishedOnly.HasValue && visibleContentPublishedOnly.Value)
                        query = query.Where(m => m.ContentPublished);
                    ...
                    if (industryId > 0)
                        query = query.Where(m => m.IndustryId == industryId);
        ...
        public virtual async Task<Manufacturer> GetManufacturerByNameAsync(string name)
        {
            ...
            var query = from p in _manufacturerRepository.Table
                        ...
                        p.Name == name
                        select p;
            var manufacturer = await query.FirstOrDefaultAsync();
        ...
        public virtual async Task<IList<int>> GetAppliedManufacturerIdsAsync(Discount discount, Customer customer)
        {
            ...
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeDiscountDefaults.ManufacturerIdsByDiscountCacheKey,
                discount,
        ...
        public virtual async Task<IList<Manufacturer>> GetManufacturersByCategoryIdAsync(int categoryId)
        {
            ...
            var key = _staticCacheManager
                .PrepareKeyForDefaultCache(ZarayeCatalogDefaults.ManufacturersByCategoryCacheKey, categoryId.ToString());
            ...
            bool showHidden = false, bool? isAppPublished = null)
        {
            ...
            if (!showHidden)
            {
                var manufacturersQuery = _manufacturerRepository.Table;

                if (isAppPublished.HasValue && isAppPublished.Value == true)
                    manufacturersQuery = _manufacturerRepository.Table.Where(m => m.AppPublished);
                else
                    manufacturersQuery = _manufacturerRepository.Table.Where(m => m.Published);
            ...
            if (isAppPublished.HasValue && isAppPublished.Value == true)
            {
                var manufacturersQuery = _manufacturerRepository.Table.Where(m => m.AppPublished);
                query = query.Where(pm => manufacturersQuery.Any(m => m.Id == pm.ManufacturerId));
            }
        ...
        public virtual async Task<IList<Manufacturer>> GetAllBrandsDisplayedOnHomepageAsync()
        {
        ...
        public virtual async Task<IList<Manufacturer>> GetAllBrandsByProductIdAsync(int productId, bool showHidden = false, bool? isAppPublished = null)
        {
            if (productId == 0)
                return new List<Manufacturer>();
        ...
        public virtual async Task<IList<Manufacturer>> GetAllBrandsByIndustryIdAsync(int industryId, bool showHidden = false, bool? isAppPublished = null)
        {
            if (industryId == 0)
                return new List<Manufacturer>();

            var query = from i in _industryRepository.Table
                        join m in _manufacturerRepository.Table on i.Id equals m.IndustryId
                        where m.IndustryId == industryId && !m.Deleted
                        orderby m.DisplayOrder, m.Id
                        select m;
        ...
        #region CustomMehtod
        public virtual async Task<IList<Manufacturer>> SearchManufacturersAsync(string keywords = null, bool searchManufactureTags = false, bool showHidden = false, bool? overridePublished = null, bool? isAppPublished = null)
        {
            var query = _manufacturerRepository.Table;
            ...
            {
                IQueryable<int> ManufacturesByKeywords;

                ManufacturesByKeywords =
                        from c in _manufacturerRepository.Table
                        where c.Name.Contains(keywords)
                        select c.Id;


                if (searchManufactureTags)
                {
                    ManufacturesByKeywords = ManufacturesByKeywords.Union(
                        from cctm in _manufacturerTagMappingRepository.Table
                        join ct in _manufacturerTagRepository.Table on cctm.ManufacturerTagId equals ct.Id
                        where ct.Name == keywords
                        select cctm.ManufacturerId
                    );
                ...
                query =
                    from p in query
                    from pbk in LinqToDB.LinqExtensions.InnerJoin(ManufacturesByKeywords, pbk => pbk == p.Id)
                    select p;
            }
        ...
        public virtual async Task<IList<Product>> GetAllProductsByBrandIdAsync(int brandId, bool showHidden = false, bool? isAppPublished = null)
        {
            if (brandId == 0)
            ...
            var query = from p in _productRepository.Table
                        ...
                        where pmm.ManufacturerId == brandId && !p.Deleted
