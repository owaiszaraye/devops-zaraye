...
namespace Zaraye.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        public virtual async Task<IList<ProductAttributeMapping>> GetProductAttributeMappingsByProductIdAsync(int productId)
        {
            ...
            var attributes = await query.ToListAsync() ?? new List<ProductAttributeMapping>();
            return attributes;
        }
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.ProductAttributeValuesByAttributeCacheKey, productAttributeMappingId);
        ...
        public virtual async Task<IList<int>> GetProductAttributeMappingIdsValuesAsync(string productAttributeValue)
        {
            var query = from pav in _productAttributeValueRepository.Table
                        where pav.Name == productAttributeValue
                        select pav.ProductAttributeMappingId;
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.PredefinedProductAttributeValuesByAttributeCacheKey, productAttributeId);
        ...
        public virtual async Task<IList<ProductAttributeCombination>> GetAllProductAttributeCombinationsAsync(int productId)
        {
            ...
            var combinations = await _productAttributeCombinationRepository.GetAllAsync(query =>
            {
                return from c in query
                    ...
                    select c;
            }, cache => cache.PrepareKeyForDefaultCache(ZarayeCatalogDefaults.ProductAttributeCombinationsByProductCacheKey, productId));
