...
namespace Zaraye.Services.Catalog
{
    ...
    public partial interface IManufacturerService
    {
        ...
        /// </returns>
        Task<IList<ProductManufacturer>> GetProductManufacturersByProductIdAsync(int productId,
        ...
        Task<IList<Manufacturer>> GetAllBrandsDisplayedOnHomepageAsync();

        Task<IList<Manufacturer>> GetAllBrandsByProductIdAsync(int productId, bool showHidden = false, bool? isAppPublished = null);

        Task<IList<Manufacturer>> SearchManufacturersAsync(string keywords = null, bool searchManufactureTags = false, bool showHidden = false, bool? overridePublished = null, bool? isAppPublished = null);

        Task<IList<Product>> GetAllProductsByBrandIdAsync(int brandId, bool showHidden = false, bool? isAppPublished = null);

        Task<IList<Manufacturer>> GetAllBrandsByIndustryIdAsync(int industryId, bool showHidden = false, bool? isAppPublished = null);
    }
}