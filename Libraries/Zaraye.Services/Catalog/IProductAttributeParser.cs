...
namespace Zaraye.Services.Catalog
{
    ...
    public partial interface IProductAttributeParser
    {
        ...
        int ParseSelectedProductAttribute(Product product, IFormCollection form);
        int ParseSelectedBrand(Product product, IFormCollection form);
        string ParseSelectedOtherBrand(Product product, IFormCollection form);
