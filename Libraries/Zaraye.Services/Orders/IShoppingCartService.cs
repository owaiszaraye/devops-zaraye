...
namespace Zaraye.Services.Orders
{
    ...
    public partial interface IShoppingCartService
    {
        ...
        /// The task result contains the warnings
        /// </returns>
        Task<IList<string>> GetShoppingCartWarningsAsync(IList<ShoppingCartItem> shoppingCart, bool validateCheckoutAttributes);
        ...
        Task<IList<string>> AddToCartAsync(Customer customer, Product product,
             ...
             decimal overridePrice = decimal.Zero, int brandId = 0,
             int supplierId = 0);
