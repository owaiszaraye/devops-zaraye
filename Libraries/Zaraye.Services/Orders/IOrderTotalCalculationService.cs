...
namespace Zaraye.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
       ...
       // Task<decimal?> GetShoppingCartShippingTotalAsync(IList<ShoppingCartItem> cart);
        ...
        /// </returns>
        //Task<(decimal? shoppingCartTotal, decimal discountAmount, List<Discount> appliedDiscounts, int redeemedRewardPoints, decimal redeemedRewardPointsAmount)> GetShoppingCartTotalAsync(IList<ShoppingCartItem> cart,
