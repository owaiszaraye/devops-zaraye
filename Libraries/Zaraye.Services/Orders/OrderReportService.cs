...
namespace Zaraye.Services.Orders
{
    ...
    public partial class OrderReportService : IOrderReportService
    {
        ...
        public virtual async Task<OrderAverageReportLine> GetOrderAverageReportLineAsync(int storeId = 0,
            int productId = 0, int warehouseId = 0, int billingCountryId = 0,
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<IPagedList<BestsuppliersReportLine>> BestSuppliersReportAsync(
            int categoryId = 0,
            int manufacturerId = 0,
            int storeId = 0,
            DateTime? createdFromUtc = null,
            ...
            bool showHidden = false)
        {
            var bestSuppliers = SearchOrderItems(categoryId, manufacturerId, storeId, createdFromUtc, createdToUtc, os, ps, ss, billingCountryId, showHidden);

            var bsReport =
                //group by products
                from orderItem in bestSuppliers
                group orderItem by orderItem.ProductId into g
                select new BestsuppliersReportLine
                {
                    ProductId = g.Key,
        ...
        /// <summary>
        /// Get best suppliers total amount
        /// </summary>
        /// <param name="storeId">Store identifier (orders placed in a specific store); 0 to load all records</param>
        /// <param name="vendorId">Vendor identifier; 0 to load all records</param>
        /// <param name="categoryId">Category identifier; 0 to load all records</param>
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<decimal> BestSuppliersReportTotalAmountAsync(
            int categoryId = 0,
            int manufacturerId = 0,
            int storeId = 0,
            DateTime? createdFromUtc = null,
            ...
            bool showHidden = false)
        {
            return await SearchOrderItems(categoryId, manufacturerId, storeId, createdFromUtc, createdToUtc, os, ps, ss, billingCountryId, showHidden: showHidden)
                .SumAsync(bestsupplier => bestsupplier.PriceExclTax);
        }
        ...
        /// The task result contains the products
        /// </returns>
        public virtual async Task<IPagedList<Product>> ProductsNeverSoldAsync(int storeId = 0,
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<decimal> ProfitReportAsync(int storeId = 0, int productId = 0,
