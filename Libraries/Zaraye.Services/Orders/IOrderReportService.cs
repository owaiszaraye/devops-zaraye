...
namespace Zaraye.Services.Orders
{
    ...
    public partial interface IOrderReportService
    {
        ...
        /// The task result contains the result
        /// </returns>
        Task<OrderAverageReportLine> GetOrderAverageReportLineAsync(int storeId = 0, int productId = 0,
        ...
        /// The task result contains the result
        /// </returns>
        Task<IPagedList<BestsuppliersReportLine>> BestSuppliersReportAsync(
            int categoryId = 0,
            int manufacturerId = 0, 
            int storeId = 0,
            DateTime? createdFromUtc = null,
        ...
        /// <summary>
        /// Get a total amount of best suppliers
        /// </summary>
        /// <param name="storeId">Store identifier (orders placed in a specific store); 0 to load all records</param>
        /// <param name="vendorId">Vendor identifier; 0 to load all records</param>
        /// <param name="categoryId">Category identifier; 0 to load all records</param>
        ...
        /// The task result contains the result
        /// </returns>
        Task<decimal> BestSuppliersReportTotalAmountAsync(
            int categoryId = 0,
            int manufacturerId = 0,
            int storeId = 0,
            DateTime? createdFromUtc = null,
        ...
        /// The task result contains the products
        /// </returns>
        Task<IPagedList<Product>> ProductsNeverSoldAsync(int storeId = 0,
        ...
        /// The task result contains the result
        /// </returns>
        Task<decimal> ProfitReportAsync(int storeId = 0, int productId = 0,
            int warehouseId = 0, int billingCountryId = 0, int orderId = 0, string paymentMethodSystemName = null,
            List<int> osIds = null, List<int> psIds = null, List<int> ssIds = null,
            DateTime? startTimeUtc = null, DateTime? endTimeUtc = null,
            string billingPhone = null, string billingEmail = null, string billingLastName = "", string orderNotes = null);
