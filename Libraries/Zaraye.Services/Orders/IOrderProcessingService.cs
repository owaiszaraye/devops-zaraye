...
namespace Zaraye.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
       ...
       // Task<bool> CanRetryLastRecurringPaymentAsync(Customer customer, RecurringPayment recurringPayment);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task ShipAsync(Shipment shipment, bool notifyCustomer, DateTime? shippedDate = null);
        ...
        /// <param name="notifyCustomer">True to notify customer</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeliverAsync(Shipment shipment, bool notifyCustomer, DateTime? deliveryDate = null);
       ...
       // Task<IList<string>> VoidAsync(Order order);
        ...
        /// <param name="order">The order</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<int> ReOrderAsync(Order parentorder, decimal returnedQuantity);
        ...
        Task<bool> IsPartialCancellationAllowedAsync(Order parentOrder);
        ...
        Task PartialCancelSOOrderAsync(Order order, bool notifyCustomer, decimal quantity, string reason);
        Task ReCalculateSaleOrderCalculationAsync(Order order, Request request, decimal quantity);
        Task PartialCancelPOOrderAsync(Order order, bool notifyCustomer, decimal quantity, string reason);
        Task ReCalculatePurchaseOrderCalculationAsync(Order order, Quotation quotation, decimal quantity);
    }
}
