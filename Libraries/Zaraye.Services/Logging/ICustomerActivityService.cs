...
namespace Zaraye.Services.Logging
{
    ...
    public partial interface ICustomerActivityService
    {
        ...
        Task<ActivityLog> InsertActivityAsync(string systemKeyword, string comment, BaseEntity entity = null, int onlineLeadStatusId = 0, string oldJson = null, string newJson = null);
        Task<ActivityLog> InsertActivityAsync(Customer customer, string systemKeyword, string comment, BaseEntity entity = null, int onlineLeadStatusId = 0, string oldJson = null, string newJson = null);
