...
namespace Zaraye.Services.Logging
{
    ...
    public partial class CustomerActivityService : ICustomerActivityService
    {
        ...
        /// The task result contains the activity log item
        /// </returns>
        public virtual async Task<ActivityLog> InsertActivityAsync(string systemKeyword, string comment, BaseEntity entity = null, int onlineLeadStatusId = 0, string oldJson = null, string newJson = null)
        {
            return await InsertActivityAsync(await _workContext.GetCurrentCustomerAsync(), systemKeyword, comment, entity, onlineLeadStatusId, oldJson, newJson);
        }
        ...
        /// The task result contains the activity log item
        /// </returns>
        public virtual async Task<ActivityLog> InsertActivityAsync(Customer customer, string systemKeyword, string comment, BaseEntity entity = null, int onlineLeadStatusId = 0, string oldJson = null, string newJson = null)
        {
            if (customer == null)
                return null;
            ...
            var logItem = new ActivityLog
            {
                ...
                CreatedOnUtc = DateTime.UtcNow,
                IpAddress = _webHelper.GetCurrentIpAddress(),
                OnlineLeadStatusId = onlineLeadStatusId > 0 ? onlineLeadStatusId : 0,
                Data = oldJson,
                NewData = newJson
