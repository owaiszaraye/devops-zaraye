...
namespace Zaraye.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        private async Task UpdateCustomerStatsAsync(int customerId)
        {
            ...
            await _genericAttributeService.SaveAttributeAsync(customer, ZarayeCustomerDefaults.ForumPostCountAttribute, numPosts);
        }
        ...
        public virtual async Task<IList<Forum>> GetAllForumsByGroupIdAsync(int forumGroupId)
        {
            var forums = await _forumRepository.GetAllAsync(query =>
            {
                return from f in query
                    ...
                    select f;
            }, cache => cache.PrepareKeyForDefaultCache(ZarayeForumDefaults.ForumByForumGroupCacheKey, forumGroupId));
        ...
        public virtual async Task UpdateForumAsync(Forum forum)
        {
            ...
            if (forumToUpdate.ForumGroupId != forum.ForumGroupId)
                await _staticCacheManager.RemoveAsync(ZarayeForumDefaults.ForumByForumGroupCacheKey, forumToUpdate.ForumGroupId);
        ...
        public virtual async Task InsertPrivateMessageAsync(PrivateMessage privateMessage)
        {
            ...
            if (customerTo == null)
                throw new ZarayeException("Recipient could not be loaded");

            //UI notification
            await _genericAttributeService.SaveAttributeAsync(customerTo, ZarayeCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, false, privateMessage.StoreId);
        ...
        public virtual async Task<string> GetTopicSeNameAsync(ForumTopic forumTopic)
        {
            ...
            var maxLength = ZarayeSeoDefaults.ForumTopicLength;
