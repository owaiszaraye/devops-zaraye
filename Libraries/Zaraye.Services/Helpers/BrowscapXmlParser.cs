...
namespace Zaraye.Services.Helpers
{
    /// <summary>
    ...
    public partial class BrowscapXmlHelper
    {
        ...
        public BrowscapXmlHelper(string userAgentStringsPath, string crawlerOnlyUserAgentStringsPath, IZarayeFileProvider fileProvider)
        {
