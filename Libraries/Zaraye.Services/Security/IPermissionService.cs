...
namespace Zaraye.Services.Security
{
    ...
    public partial interface IPermissionService
    {
        ...
        Task<IList<PermissionRecord>> GetAllPermissionRecordsAsync(string categoryName = null);

        Task<int> GetPermissionRecordIdBySystemNameAsync(string systemName);
        /// <summary>
        ...
        Task<IPagedList<PermissionRecord>> GetPermissionRecordsByCustomerRoleIdAsync(int roleId, int pageIndex = 0, int pageSize = int.MaxValue);
        Task<PermissionRecordCustomerRoleMapping> GetMappingByPermissionRecordIdAndRoleIdAsync(int permissionId, int roleId);
    }
}