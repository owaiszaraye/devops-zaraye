...
using Zaraye.Services.Html.CodeFormatter;

namespace Zaraye.Services.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper : IBBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceImg)
                // format the img tags: [img]https://www.zaraye.co/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.zaraye.co/Content/Images/Image.jpg">
