...
namespace Zaraye.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        Task<IList<int>> SendCustomerRegisteredNotificationWithPasswordMessageAsync(Customer employee, int languageId, string randomGeneratedPassword);
        ...
        /// The task result contains the queued email identifier
        /// </returns>
        Task<IList<int>> SendContactUsMessageAsync(int languageId, string senderEmail, string senderName, string subject, string body, string senderContactNumber,string company,string country);
        ...
        Task<IList<int>> SendOnlineLeadNotificationMessageAsync(OnlineLead onlineLead, int languageId);
        Task<IList<int>> SendFeedbackOwnerEmailNotificationAsync(AppFeedBack appFeedBack, int languageId);
        Task<IList<int>> SendBuyerRegisteredNotificationMessageAsync(Customer buyer, int languageId);
        Task<IList<int>> SendSupplierRegisteredNotificationMessageAsync(Customer supplier, int languageId);
        Task<IList<int>> SendBuyerOTPNotificationMessageAsync(Customer customer, int languageId, string OTP);
        ...
        Task<IList<int>> SendBuyerWelcomeMessageAsync(Customer customer, int languageId);
        Task<IList<int>> SendSupplierWelcomeMessageAsync(Customer customer, int languageId);

        Task<IList<int>> SendFeedbackNotificationToAdminAsync(AppFeedBack appFeedBack, int languageId);
        Task<IList<int>> SendFeedbackNotificationToCustomerAsync(AppFeedBack appFeedBack, int languageId);

        Task<IList<int>> SendPaymentApprovedNotificationAsync(Payment payment, Customer customer, string paymentAmount, string orderPaymentType, int languageId, string attachMultipleFilePathsAndName);
        Task<IList<int>> SendPaymentRejectedNotificationAsync(Payment payment, Customer customer, string paymentAmount, string orderPaymentType, int languageId);

        Task<IList<int>> SendBuyerRequirementConvertLeadToRequestMessageAsync(Customer buyer, Request Request, int languageId, string pocEmail, string pocName);
