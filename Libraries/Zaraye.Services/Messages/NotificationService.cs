...
namespace Zaraye.Services.Messages
{
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(ZarayeMessageDefaults.NotificationListKey)
                ? JsonConvert.DeserializeObject<IList<NotifyData>>(tempData[ZarayeMessageDefaults.NotificationListKey].ToString())
                : new List<NotifyData>();
            ...
            tempData[ZarayeMessageDefaults.NotificationListKey] = JsonConvert.SerializeObject(messages);
        }
