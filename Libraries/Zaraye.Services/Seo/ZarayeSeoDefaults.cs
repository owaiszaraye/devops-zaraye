...
namespace Zaraye.Services.Seo
{
    ...
    /// </summary>
    public static partial class ZarayeSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordCacheKey => new("Zaraye.urlrecord.{0}-{1}-{2}");
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new("Zaraye.urlrecord.byslug.{0}");
