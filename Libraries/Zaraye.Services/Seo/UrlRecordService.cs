...
namespace Zaraye.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        public UrlRecordService(ILanguageService languageService,
            ...
            SeoSettings seoSettings, IStoreContext storeContext)
        {
        ...
        public virtual async Task<UrlRecord> GetBySlugAsync(string slug)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeSeoDefaults.UrlRecordBySlugCacheKey, slug);
        ...
        {
            //gradual loading
            var key = _staticCacheManager.PrepareKeyForDefaultCache(ZarayeSeoDefaults.UrlRecordCacheKey, entityId, entityName, languageId);
        ...
        public virtual async Task<string> ValidateSeNameAsync(int entityId, string entityName, string seName, string name, bool ensureNotEmpty)
        {
            ...
            //max length
            seName = CommonHelper.EnsureMaximumLength(seName, ZarayeSeoDefaults.SearchEngineNameLength);
