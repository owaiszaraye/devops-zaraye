...
namespace Zaraye.Services.Common
{
    ...
    /// </summary>
    public static partial class ZarayeCommonDefaults
    {
        /// <summary>
        ...
        /// {3} : language code
        /// </remarks>
        public static string ZarayeLicenseCheckPath => "license-check?url={0}&version={1}&email={2}&language={3}";
        ...
        /// {4} : language code
        /// </remarks>
        public static string ZarayeNewsRssPath => "zaraye-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";
        ...
        /// {5} : culture name
        /// </remarks>
        public static string ZarayeInstallationCompletedPath => "installation-completed?version={0}&local={1}&email={2}&url={3}&language={4}&culture={5}";
        ...
        /// {0} : language code
        /// </remarks>
        public static string ZarayeExtensionsCategoriesPath => "extensions-feed?getCategories=1&language={0}";
        ...
        /// {0} : language code
        /// </remarks>
        public static string ZarayeExtensionsVersionsPath => "extensions-feed?getVersions=1&language={0}";
        ...
        /// {6} : language code
        /// </remarks>
        public static string ZarayeExtensionsPath => "extensions-feed?category={0}&version={1}&price={2}&searchTerm={3}&pageIndex={4}&pageSize={5}&language={6}";
        ...
        /// {0} : address attribute ID
        /// </remarks>
        public static CacheKey AddressAttributeValuesByAttributeCacheKey => new("Zaraye.addressattributevalue.byattribute.{0}");
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new("Zaraye.genericattribute.{0}-{1}");
